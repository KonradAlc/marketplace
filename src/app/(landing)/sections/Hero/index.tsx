      ...
      <div className='mx-auto max-w-2xl py-32 sm:py-48 lg:py-56'>
        <div className='text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-600'>
            Kupuj i sprzedawaj części, akcesoria i motocykle w jednym miejscu. Wszystko, czego potrzebujesz do swojego motocykla.
          </p>
          <div className='mt-10 flex flex-col items-center justify-center gap-y-6'>
            ...
            <Link href='/tutorials' className='text-sm font-semibold leading-6 text-gray-900'>
              Zaczynasz swoją przygodę? Sprawdź nasze poradniki <span aria-hidden='true'>→</span>
            </Link>
          </div>
        </div>
      </div>
